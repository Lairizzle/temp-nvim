...
-- Python / LSP / Ruff / Telescope / Midnight Crystal
-- ============================================================
...
--
-- This does NOT require the Ruff LSP.
-- It calls the ruff executable directly.
-- ============================================================
...
vim.api.nvim_create_autocmd("BufWritePre", {
    ...
    callback = function(args)
        ...
        -- Remove the trailing newline Ruff adds
        result = result:gsub("\n$", "")

        local formatted = vim.split(
            result,
            "\n",
            {
                plain = true,
